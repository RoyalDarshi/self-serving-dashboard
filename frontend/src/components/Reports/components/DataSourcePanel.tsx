...
import { Database, Search, Table2, Layers, Binary, ChevronLeft, ChevronRight, LayoutGrid, XCircle, ChevronDown, ChevronUp } from "lucide-react";
            ...
            >
                ...
                <div className="p-5 border-b border-zinc-100 bg-white">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        >
                            {leftPanelCollapsed ? <ChevronDown className="w-5 h-5"/> : <ChevronUp className="w-5 h-5"/>}
                        </button>
                    </div>

                    {/* Only show content if not collapsed on mobile, or always on desktop if expanded */}
                    <div className={`${leftPanelCollapsed ? "hidden lg:block lg:invisible" : "block"}`}>
                        <select
                ...
                <div className={`flex-1 overflow-y-auto p-3 custom-scrollbar ${leftPanelCollapsed ? "hidden lg:block lg:invisible" : "block"} lg:max-h-none max-h-60`}>
                    {mode === "TABLE" ? (
                        !baseTable ? (
