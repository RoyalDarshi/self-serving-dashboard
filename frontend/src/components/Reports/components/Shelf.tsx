  ...
  return (
    <div className="relative group">
      <div
        ...
        className={`flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium border shadow-sm cursor-pointer select-none transition-all ${
          isAgg
  ...
  return (
    <div className={`flex flex-col gap-2.5 ${className}`}>
      ...
      <div
        ...
        onDrop={handleDrop}
        className={`min-h-[70px] p-3 rounded-xl border-2 border-dashed transition-all flex flex-wrap gap-2 content-start ${
          isOver
